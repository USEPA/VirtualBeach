    ...
    public partial class VBProjectManager
    {
        public void Save(object sender, EventArgs e)
        {
            ...
            if (ProjectPathName == null)
            {
                ...
                if (bPredictionOnly) { strFilterstring = @"VB3 Model Files|*.vb3m"; }
                else { strFilterstring = @"VB3 Project Files|*.vb3p"; }
        ...
        public void Open(object sender, EventArgs e)
        {
            ...
            openFile.Filter = @"All VB3 Files|*.vb3m;*.vb3p|VB3 Project Files|*.vb3p|VB3 Model Files|*.vb3m";
            ...
            if (String.Equals(strFileName.Split('.').Last(), "vb3m", comparisonType: StringComparison.InvariantCultureIgnoreCase))
                { bPredictionOnly = true; }
            ...
            if (!bPredictionOnly && dictPluginStates[this.strPluginKey]["TopPlugin"] != null)
            {
            ...
            else if (bPredictionOnly) { signaller.ActivatePredictionPlugin(); }
