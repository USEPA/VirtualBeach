    ...
    public partial class frmLocation : UserControl
    {
        ...
        private void showDefaultMap()
        {
            if (!DesignMode)
            {
                ...
                //red arrow beach, manitowoc WI
                MainMap.CurrentPosition = new PointLatLng(44.0766102719193, -87.6560497283936);
        ...
        private MapType[] GetMapTypes()
        {
            ...
            //we're down to an osm and bing maps - mog 10/20/14
            excludedMapTypes.Add(MapType.OpenStreetOsm);
            excludedMapTypes.Add(MapType.YahooHybrid);
            excludedMapTypes.Add(MapType.YahooLabels);
            excludedMapTypes.Add(MapType.YahooMap);
            excludedMapTypes.Add(MapType.YahooSatellite);
