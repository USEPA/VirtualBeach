...
namespace VBCommon
{
    public class Signaller
    {
        ...
        public event EventHandler<EventArgs> ActivatePrediction;
        ...
        //Activate the prediction plugin
        public void ActivatePredictionPlugin()
        {
            if (ActivatePrediction != null) //Has some method been told to handle this event?
            {
                bEnableBroadcast = false;

                EventArgs e = new EventArgs();
                ActivatePrediction(this, e);
