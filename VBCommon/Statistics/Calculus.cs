...
namespace VBCommon.Statistics
{
    public class Calculus
    {
        ...
        public double Integrate()
        {
            ...
            double result = MathNet.Numerics.Integration.NewtonCotesTrapeziumRule.IntegrateAdaptive(Integrand, 0, 1, 0.00001d);
            return result;
        }
        ...
        {
            var curve = MathNet.Numerics.Interpolation.LinearSpline.Interpolate(_X, _Y);
