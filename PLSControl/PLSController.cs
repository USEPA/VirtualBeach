...
namespace PLSControl
{
    ...
    {
        public RModelInterface Deserialize(object ModelState)
        {
            PLSModel model =  new PLSModel();
            Dictionary<string, object> dictModelState = (Dictionary<string, object>)ModelState;
            model.UnpackState(dictModelState);
