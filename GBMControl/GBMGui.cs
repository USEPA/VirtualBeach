...
namespace GBMControl
{
    ...
    public partial class GBMGui : RModelingGui
    {
        public GBMGui() : base()
        {
            InitializeComponent();
            strMethod = "GBM";
            Controller = new GBMController();
        }
        ...
        protected override void PopulateResults(RModelInterface Model)
        {
            ...
            List<string> listKeys = dictInfluence.Keys.ToList();
            List<double> listInfluence = dictInfluence.Values.ToList();
